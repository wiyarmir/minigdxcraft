...
public class TextParticle extends Entity {
	...
	public void render(PortScreen screen) {
		// Font.draw(msg, screen, x - msg.length() * 4, y, Color.get(-1, 0, 0,
		// 0));
		PortFont.draw(msg, screen, x - msg.length() * 4 + 1, y - (int) (zz) + 1,
				Color.get(-1, 0, 0, 0));
		PortFont.draw(msg, screen, x - msg.length() * 4, y - (int) (zz), col);
	}
